...
const CodeDisplay = () => {
  ...
  const profile = {
    ...
    return (
      <div className="bg-gray-900 p-4 rounded-lg shadow-lg max-w-4xl mx-auto mt-10">
        {/* Mock Window Header */}
        <div className="flex items-center justify-between bg-gray-800 p-2 rounded-t-lg">
          ...
          <span className="text-white text-sm font-semibold">developer.js</span>
        </div>
  
        {/* Code Block */}
        <pre className="language-javascript mt-2">
