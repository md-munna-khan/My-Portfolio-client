          ...
          <div className="col-span-4 md:col-span-2">
            ...
            <div className="rounded-lg">
              <a
                ...
                className="inline-flex text-white items-center p-2 bg-green-500 rounded mt-2"
              >
            ...
            <div className="mt-4 flex justify-evenly">
              ...
              <div>
                <button onClick={handleBackToHome} className="bg-green-500 text-white rounded mt-2 px-1 py-1 md:p-2">
                  Back to Home
                </button>
              </div>
            </div>
